    ...
    <v-main>
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card style="width: 600px">
                ...
                <v-card-text>
                    <v-container>
                        <v-text-field v-model="form.kodePromo" label="Kode Promo" required></v-text-field>
                        <v-text-field v-model="form.namaPromo" label="Nama Promo" required></v-text-field>
                        <v-text-field v-model="form.keteranganPromo" label="Keterangan" required></v-text-field>
                    </v-container>
                </v-card-text>
                <v-card-action>
                    <v-spacer></v-spacer>
...
<script>
    export default {
        ...
        methods: {
            ...
            //SIMPAN
            save() {
                this.promo.append('kodePromo', this.form.kodePromo);
                this.promo.append('namaPromo', this.form.namaPromo);
                this.promo.append('keteranganPromo', this.form.keteranganPromo);
            ...
            update() {
                let newData = {
                    ...
                    keteranganPromo : this.form.keteranganPromo,
                };
            ...
            editHandler(item) {
                ...
                this.form.keteranganPromo = item.keteranganPromo;
                this.dialog = true;
            },
            deleteHandler(id) {
                this.deleteId = id;
